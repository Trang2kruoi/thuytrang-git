...
{
    public abstract class thuytrangWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static thuytrangWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(thuytrangWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<thuytrangDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<thuytrangDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<thuytrangDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<thuytrangDbContext, Task<T>> func)
        {
            T result;
